export const translations = {
  en: {
    ...
    sections: {
      ...
      aboutBody: "Born in the heart of Bordj Bou Arreridj, Spart is a celebration of bold flavors and Algerian warmth. Every dish is crafted with precision, passion, and a commitment to quality that rivals the finest establishments.",
      contactTitle: "Contact Us",
      contactSub: "Request a reservation or inquire about private events.",
  ...
  fr: {
    ...
    sections: {
      ...
      experienceTitle: "Notre",
      experienceTitleItalic: "Promesse",
      ...
      aboutBody: "Né au cœur de Bordj Bou Arreridj, Spart est une célébration de saveurs audacieuses et de la chaleur algérienne. Chaque plat est préparé avec précision, passion et un engagement envers la qualité.",
      contactTitle: "Contactez-Nous",
      contactSub: "Demandez une réservation ou renseignez-vous sur les événements privés.",
  ...
  ar: {
    ...
    sections: {
      ...
      experienceTitle: "وعدنا",
      experienceTitleItalic: "لك",
      ...
      aboutBody: "وُلد سبارت في قلب برج بوعريريج، احتفالاً بالنكهات الجريئة والدفء الجزائري. كل طبق يُعدّ بدقة وشغف والتزام بالجودة يُنافس أرقى المطاعم.",
      contactTitle: "اتصل بنا",
      contactSub: "احجز طاولة أو استفسر عن الفعاليات الخاصة.",
